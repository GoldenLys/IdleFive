...
var texts = {
    ...
    character: ["Change character", "You are actually using the character number", "You must reach the rank", "and get", "to switch to another character.", "You can currently get", "Character Points (CP) for your new character.", "Current prestige multiplier at", "(+10% per character) for earnt cash & damage."],
